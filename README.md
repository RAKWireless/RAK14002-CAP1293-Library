...
Optional parameter I2C address of the CAP1293
...
Returns true if CAP1293 was detected. Otherwise returns false.

`bool isConnected();`        
Check if touch button module is connected.    
Returns true if the I2C Device acknowledgs a connection. Otherwise returns false.
...
Returns content of status register
